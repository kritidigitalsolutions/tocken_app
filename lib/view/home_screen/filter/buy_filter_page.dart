              ...
              SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _toggleButtons(),
                    SizedBox(height: 15),
                    Text("Property Type", style: textStyle15(FontWeight.bold)),
                    SizedBox(height: 10),
                    Wrap(
                      spacing: 10,
                      runSpacing: 10,
                    ...
                    SizedBox(height: 15),
                    Text("Built up area", style: textStyle15(FontWeight.bold)),
                    SizedBox(height: 10),
                    Row(
                      children: [
                    ...
                    SizedBox(height: 15),
                    Text("Furnish Type", style: textStyle15(FontWeight.bold)),
                    SizedBox(height: 10),
                    Wrap(
                      spacing: 10,
                      runSpacing: 10,
