              ...
              child: widget.propertyType == "Plot/Land"
                  ? Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            Expanded(
                              flex: 1,
                              child: _unitDropdown(
                                value: p.plotMeasuType,
                                item: p.measurmentList,
                                onChanged: (v) => p.setPlotArea(v ?? ''),
                              ),
                            ),
                          ],
                        ),
                        ...
                        _title("Lenght"),
                        AppNumberField(
                          controller: p.lengthCtr,
                          hintText: "Lenght of the plot",
                          textWidget: p.plotMeasuType,
                        ),
                        if (p.areaError != null)
                          Text(
                            p.areaError!,
                        ...
                        Row(
                          children: [
                            ...
                            Expanded(
                              flex: 1,
                              child: _unitDropdown(
                                value: p.facingRoadMeasuType,
                                item: p.measurmentList,
                                onChanged: (v) =>
                                    p.setWidthRaodSideArea(v ?? ''),
                              ),
                            ),
                          ],
                        ),
                        ...
                        Wrap(
                          spacing: 10,
                          children: List.generate(p.noOfBathroom.length, (
                            index,
                          ) {
                                    ...
                                    Expanded(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          const SizedBox(height: 6),
                                          AppNumberField(
                                            controller: p.totalFloorsController,
